        ...
        <Fade left duration={1000} distance="40px">
            <Card style={{flex: 1}} className="shadow-lg--hover shadow border-0 text-center rounded">
                ...
                <CardBody className="py-5">
                    <img ref={imgRef} className=" exp-card bg-white rounded-circle mb-3 img-center img-fluid" top src={data.companylogo} style={{ width: "120px" }} onLoad={() => getColorArrays()} alt=""/>
